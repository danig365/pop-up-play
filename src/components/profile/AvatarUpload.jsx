...
export default function AvatarUpload({ currentAvatar, onAvatarChange }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-gradient-to-r from-violet-600 to-purple-600 rounded-full flex items-center justify-center shadow-lg">
